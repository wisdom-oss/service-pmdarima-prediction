...
def query_fetch_one(
    query_string: str, params: list[str | datetime.datetime]
) -> interfaces.FetchOneQueryDict | None:
    """
...
def select_date_value(
    meter_name: str, start: datetime.datetime, end: datetime.datetime
) -> interfaces.SelectDateValueData | None:
    """
